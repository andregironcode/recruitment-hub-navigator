...
const Contact = () => {
  ...
  return (
    <Layout>
      <div className="bg-recruitment-light min-h-screen py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-recruitment-dark mb-2">Contact Us</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Have questions about our services or need assistance with your job search or hiring needs?
              We're here to help. Reach out to us using the form below or contact details.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-8 rounded-lg shadow-sm h-full">
                <h2 className="text-2xl font-semibold mb-6 text-recruitment-dark">Get in Touch</h2>
                
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="bg-recruitment-light p-3 rounded-full text-recruitment-primary mr-4">
                      <Phone size={20} />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-recruitment-dark">Office</h3>
                ...
                <div className="mt-8">
                  <h3 className="font-medium text-recruitment-dark mb-3">Connect With Us</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-recruitment-light p-2 rounded-full text-recruitment-primary hover:bg-recruitment-primary hover:text-white transition-colors">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <h2 className="text-2xl font-semibold mb-6 text-recruitment-dark">Send Us a Message</h2>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <Button 
                    type="submit" 
                    className="bg-recruitment-primary hover:bg-recruitment-primary/90 px-8"
                  >
                    Send Message
                  </Button>
                </form>
