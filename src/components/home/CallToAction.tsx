          ...
          <div className="p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                Partner with the Heather Harries Group to find exceptional talent that will drive your business forward. Our team of specialists is ready to help you achieve your goals.
              </p>
            ...
            <motion.div 
              className="md:w-1/3 bg-recruitment-primary/5 p-6 md:p-8 rounded-xl border border-recruitment-primary/10"
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <a 
                    href="mailto:James@harriesgroup.com" 
