...
const TeamSection = () => {
  ...
  return <section className="py-16 md:py-24 bg-gradient-to-b from-white to-recruitment-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        duration: 0.5
          ...
          <div className="flex justify-center mb-6">
            <motion.img src="/placeholder-icon.svg" alt="Team Icon" className="w-12 h-12" animate={{
            rotate: 360
          }} transition={{
            duration: 20,
            repeat: Infinity,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          delay: index * 0.1
              ...
              <Card className={`h-full overflow-hidden transition-all duration-300 ${activeCard === index ? 'shadow-xl border-recruitment-primary/50 transform -translate-y-2' : 'hover:shadow-lg border-2 border-transparent hover:border-recruitment-primary/20 hover:-translate-y-1'}`} onClick={() => setActiveCard(activeCard === index ? null : index)}>
                <div className="h-48 overflow-hidden relative">
                  <motion.div className="absolute inset-0 bg-gradient-to-b from-recruitment-primary/10 to-recruitment-primary/60 z-10" initial={{
                opacity: 0
              }} whileInView={{
                opacity: 1
              }} viewport={{
                once: true
                  ...
                  <motion.img src={member.image} alt={member.name} className="w-full h-full object-cover object-center" whileHover={{
                scale: 1.05
              }} transition={{
                type: "spring",
                stiffness: 200,
                ...
                <CardContent className="pt-6 pb-6 px-6">
                  <div className="flex flex-col items-center">
                    <motion.div className="relative -mt-16 mb-4 z-20" whileHover={{
                  scale: 1.05
                }} transition={{
                  type: "spring",
                  stiffness: 400,
                  ...
                  duration: 0.3
                    ...
                    <motion.button className="mt-4 text-recruitment-primary text-sm font-medium flex items-center" whileHover={{
                  scale: 1.05
                }} whileTap={{
                  scale: 0.95
                }}>
        ...
        <motion.div className="mt-16 flex flex-col md:flex-row items-center justify-center bg-white rounded-xl p-8 shadow-xl border border-gray-100" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        delay: 0.3
          ...
          <div className="md:w-1/3 mb-6 md:mb-0 flex justify-center">
            <motion.div className="rounded-lg overflow-hidden shadow-lg">
              <motion.img alt="Heather Harries" className="max-w-full h-auto md:max-w-xs" whileHover={{
              scale: 1.05
            }} transition={{
              type: "spring",
              stiffness: 400,
              damping: 17
            }} src="/lovable-uploads/c7e44165-912c-4c97-ba1a-0e67c173143d.jpg" />
            </motion.div>
          </div>
          <div className="md:w-2/3 md:pl-10">
            <motion.blockquote className="text-xl md:text-2xl font-medium text-recruitment-primary italic mb-4" initial={{
            opacity: 0,
            x: 20
          }} whileInView={{
            opacity: 1,
            ...
            <motion.cite className="text-gray-600 not-italic" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} viewport={{
